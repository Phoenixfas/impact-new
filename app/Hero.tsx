...
export default function Hero() {
    ...
    return (
        <div className='relative w-full h-screen flex flex-col overflow-hidden bg-primary'>
            ...
            <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
                <video className='peer max-w-xl w-full h-full object-cover bg-transparent hover:brightness-125 hover:scale-105 duration-300 z-10' autoPlay loop muted playsInline controls={false}>
                    <source src="/videos/output.webm" type="video/mp4" />
                    Your browser does not support the video tag.
                </video>
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[radial-gradient(circle,_var(--tertiary)0%,_var(--secondary)20%,_transparent_70%)] blur-lg opacity-75 rounded-full peer-hover:scale-110 duration-300"></div>
            </div>
            ...
            <div className="absolute bottom-0 pb-20 px-5 md:px-20 w-full flex items-end justify-center">
                <div className="relative w-full h-full flex items-end justify-between text-white text-7xl leading-[5rem] tracking-widest font-black k2d-extrabold uppercase">
